...
CREATE TABLE exchange_rates (
                                ...
                                previous_close_rate DECIMAL(18,8),
                                source              VARCHAR(50),
                                created_at          TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,
                                updated_at          TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP,

                                CONSTRAINT uk_exchange_rates_pair_date UNIQUE (currency_pair, rate_date)
);
...
CREATE TABLE transactions (
                              ...
                              CONSTRAINT fk_transactions_limit FOREIGN KEY (limit_id) REFERENCES limits(id) ON DELETE SET NULL
);
